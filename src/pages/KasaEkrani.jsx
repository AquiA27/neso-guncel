...
import apiClient from '../services/apiClient'; // EKLENDİ
import { AuthContext } from '../AuthContext'; // EKLENDİ
import { useNavigate } from 'react-router-dom'; // EKLENDİ
import { DollarSign, CreditCard, CheckCircle, AlertCircle, RotateCw } from 'lucide-react'; // EKLENDİ
...
function KasaEkrani() {
  ...
  const logDebug = useCallback((message, ...optionalParams) => console.debug(`[Kasa Ekranı] DEBUG: ${message}`, ...optionalParams), []); // EKLENDİ
  ...
  }, [selectedOrderStatusFilter, logInfo, logError, handleApiError, parseOrderBasket, apiClient]); // apiClient eklendi bağımlılıklara
  ...
  }, [logInfo, logError, logWarn, handleApiError, apiClient]); // apiClient eklendi bağımlılıklara
  ...
  }, [logInfo, logError, logWarn, handleApiError, parseOrderBasket, apiClient]); // apiClient eklendi bağımlılıklara
